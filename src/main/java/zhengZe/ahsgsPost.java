...
//        CloseableHttpClient httpClient = HttpClients.createDefault();
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                Element uls = document.getElementsByClass("tab01open tab01tca").get(0);
                Elements lis = uls.getElementsByTag("li");
                for (Element li : lis) {
                    Element titTime = li.getElementsByClass("tit-time").get(0);
